...
export const site = {
  ...
  promises: {
    ...
    transparentSub:
      "견적서에 골프장·숙박·항공 원가와 에스티골프투어 대행비를 분리해 보여드립니다. 거품이 낄 자리가 없습니다.",
  },
  ...
  contentUpdated: "2026년 8월 25일", // 콘텐츠 최종 수정일: 내용 갱신 시 함께 갱신
  contentUpdatedISO: "2026-08-25", // 위와 항상 같은 날짜 (JSON-LD·sitemap용)
  publishedISO: "2026-08-18", // 사이트 최초 공개일

  positioning:
    "에스티골프투어(ST TOUR)는 세종시의 종합여행업 등록 골프투어 전문 여행사입니다. 고객이 원하는 지역과 날짜를 보내면 전국 500여 개 골프장과 해외 14개국의 골프장·숙박·항공을 조합해 24시간 안에 대행비까지 공개된 맞춤 견적서를 보내드립니다.",
};
