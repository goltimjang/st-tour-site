...
export const site = {
  ...
  promises: {
    ...
    transparentSub:
      "전국 504곳·해외 575곳 골프장 정보와 25,000팀을 보내드린 경험으로 지역·날짜·인원·예산에 맞는 일정을 짜드립니다. 포함·불포함 내역을 항목별로 명확히 적어 드립니다.",
  },
  ...
  contentUpdated: "2026년 9월 3일", // 콘텐츠 최종 수정일: 내용 갱신 시 함께 갱신
  contentUpdatedISO: "2026-09-03", // 위와 항상 같은 날짜 (JSON-LD·sitemap용)
  publishedISO: "2026-08-18", // 사이트 최초 공개일

  positioning:
    "에스티골프투어(ST TOUR)는 세종시의 종합여행업 등록 골프투어 전문 여행사입니다. 고객이 원하는 지역과 날짜를 보내면 전국 500여 개 골프장과 해외 14개국의 골프장·숙박·항공을 조합해 24시간 안에 조건에 맞춘 견적서를 보내드립니다.",
};
